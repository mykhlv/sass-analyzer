...
use tower_lsp_server::ls_types::{
    ...
    DidOpenTextDocumentParams, DidSaveTextDocumentParams, DocumentLinkOptions, DocumentLinkParams,
    ...
    Registration, RenameOptions, RenameParams, SemanticTokenModifier, SemanticTokenType,
